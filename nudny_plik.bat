...
@echo off
title [infinite nothing ver:5.409pll]
...
if %answer%==6 goto :6:
if %answer%==7 goto :7:
if %answer%==8 goto :Game:
if %answer%==9 goto :9:
if %answer%==10 goto :10:
if %answer%==11 goto :11:
if %answer%==12 goto :12:
if %answer%==14 goto :13:
if %answer%==15 goto :14:
if %answer%==16 goto :16:
if %answer%==17 goto :17:
if %answer%==18 goto :18:
if %answer%==19 goto :19:
if %answer%==20 goto :20:
if %answer%==21 goto :21:
if %answer%==22 goto :22:
if %answer%==23 goto :23:
if %answer%==24 goto :24:
if %answer%==25 goto :25:
if %answer%==2137 goto  :2137:
if %answer%==0 goto :0:
if not %answer%==0 goto :Menu
...
echo                   d/y@@@@@@@@@@y:                           h@@@@@@@@@@y``````:@                   
echo                   -@`o@@@@@@@@@y                          shN@@@@@@@@@@:s@+``.d/                   
echo                    oy -@@@@@@@@N.don't type 2137 at start ./@@@@@@@@@+.:Nd.``sy                    
echo                     sy.@@@@@@@`                            s@@@@@@@@y``s:```oy                     
echo                      +h-d@@@@@-                            s@@@@@ds```````.ys                      
echo                       -h/o@@@s                             `@h++/-```````/d:                       
echo                         +h+d@:                             `-``````````:yo`                        
...
echo                  .N.@@@@@@@@@@@@@@:                         +o@@@@@@@@@@N``````d:                  
echo                   d/:@@@@@@@@@@@@/.                          -@@@@@@@@@@y`````:@                   
echo                   -@`.@@@@@@@@@@N`don't type 2137 at start -h@@@@@@@@@@@:y@:`.d/                   
echo                    oy  s@@@@@@@@@/                         `.d@@@@@@@@o./Ny``sy                    
echo                     sy +@@@@@@N.                            .@@@@@@@@y`.y.``oy                     
echo                      +h`/@@@@@@:                            /h@@@@ds``````.ys                      
echo                       -h/-@@@@o                              yd++/-``````/d:                       
...
echo                  +h @@@@@@@@@@@@o++:                         :@@@@@@@@@@@@/.```ss                  
echo                  .N y@@@@@@@@@@@@@@h                         .+d@@@@@@@@@N`````d:                  
echo                   d/`y@@@@@@@@@@@@o: don't type 2137 at start  h@@@@@@@@@y````:@                   
echo                   -@``/@@@@@@@@@@@+                          sh@@@@@@@@@@-hd..d/                   
...
echo                  +h :@@@@@@@@@@@@h+++`                         d@@@@@@@@@@@/```ss                  
echo                  .N `@@@@@@@@@@@@@@@@:                         /s@@@@@@@@@@````d:                  
echo                   d/ -N@@@@@@@@@@@@d/.don't type 2137 at start  /@@@@@@@@@o```:@                   
echo                   -@` `s@@@@@@@@@@@@                          :h@@@@@@@@@N:@o.d/                   
echo                    oy   .N@@@@@@@@@@.                         `-N@@@@@@@+.yh.sy                    
echo                     sy  .N@@@@@@@+`                            o@@@@@@ds`:/`oy                     
...
set /a player_hp=15
set /a player_max_hp=100
set /a player_damage=3
set /a player_armor=1
...
:Menu2:
cls
echo menu zminy koloru tekstu
echo 1.wpisz 1 zeby zmienc kolor na fioletowy
echo 2. wpisz 2 zeby zmienc kolor na zielony
echo 3. wpisz 3 zeby zmienc kolor na niebieski
echo 4. wpisz 4 zeby zmienc kolor na czerwony
echo 5. wpisz 5 zeby zmienc kolor na rozowy
echo 6. wpisz 6 zeby zmienc kolor na jasny zielony
echo 7. wpisz 7 zeby zmienc kolor na bialy
...
if %answer%==2 goto :kolor2:
if %answer%==3 goto :kolor3:
if %answer%==4 goto :kolor4:
if %answer%==5 goto :kolor5:
if %answer%==6 goto :kolor6:
if %answer%==7 goto :kolor7:
if %answer%==8 goto :kolor8:
if %answer%==9 goto :kolor9:
...
:Menu2:
cls
echo menu wybierania koloru tla/menu of picking background color
echo 1.wpisz 1 zeby zmienc kolor na fioletowy
echo 2. wpisz 2 zeby zmienc kolor na zielony
echo 3. wpisz 3 zeby zmienc kolor na niebieski
echo 4. wpisz 4 zeby zmienc kolor na czerwony
...
set /p answer=Select Option:
if %answer%==1 goto :kolor1tlo:
if %answer%==2 goto :kolor2tlo:
if %answer%==3 goto :kolor3tlo:
if %answer%==4 goto :kolor4tlo:
if %answer%==5 goto :kolor5tlo:
if %answer%==6 goto :kolor6tlo:
if %answer%==7 goto :kolor7tlo:
if %answer%==8 goto :kolor8tlo:
if %answer%==9 goto :kolor9tlo:
if %answer%==0 goto :Menu
if not %answer%==0 goto :Menu
:25:
...
:2137:
echo sicret 1 finded
start cmd
start opera.exe https://github.com/Filip55321
start opera.exe https://github.com/Filip55321/project-nudny-plik.bat-
start firefox.exe https://github.com/Filip55321/project-nudny-plik.bat-
start firefox.exe https://github.com/Filip55321
start chrome.exe https://github.com/Filip55321
start chrome.exe https://github.com/Filip55321/project-nudny-plik.bat-
start nudny_plik.bat
echo sicret 1 finded
goto :2137: